...
const LOGO_B64 = "data:image/png;base64," + [
  ...
  "Hh4eHh4eHh4eHh4eHh4eHh4eHh4eHh4eHh4eHh4eHh7/wAARCAHKAjIDASIAAhEBAxEB/8QAHAABAQACAwEBAAAAAAAAAAAAAAEC",
  "CAMGBwUE/8QATxAAAgEDAgQDBAQJBg0CBwAAAAECAwQRBTEGIUFRBxJhEyJxgTKRobEIFBUzQlJiwdEWIzRyk7MkNkNTc3SCg5Ki",
  "suHwJfFFVFVjZMLS/8QAFAEBAAAAAAAAAAAAAAAAAAAAAP/EABQRAQAAAAAAAAAAAAAAAAAAAAD/2gAMAwEAAhEDEQA/AP2E6lGA",
  "IXIwQC8wtyonUBgLcpEBkkQvQgAmDLBAIiMyJgCAAAVEAAAACkAFRAUCFRAgADAAAuAKksEGcACFRCrcCAMAAC5AgAAAAAircgAF",
  "W5AABVuGAwshDIQFC+AIgKFuCZAoyOfYAAgACGQAAAAAAARFItwHULYpFuAD3IzJJYAxBeQABFwiAVEW5URAEUbAAAAABALkAACZ",
  "KMIDEuBgoGIDAAdQOoBDqAAAAAAAAAALkgAvQZC2ZAAAAAFW4DoQpAL0IAAAAAFIBckAAq3IwUCFRABepTEyAIjCCAFAAAiKAAAA",
  "AAOpcEGQD3HVjqAImUfAAMInoUAMIEbADJcehEn2KA6giL8wAHUiApUQAAmxz7EQFBcBATAAAuDF9TJZxuYgO5An0+47NYeH/Fuo",
  "afRv7TTqdS3rwU6cnc003F+jlkDrIOx3PAHGtvFSnw/czWP8nOnU+yMmz5d3oOu2af43o+oUcbuVvJJfYB+BFwYtuEnGSakuTTWG",
  "iqS+PqgLghl15hYyBiDLHoMAYgyJgCApAAAAqQ6jJUuoGJkkhgqAmEMIpj7zaillt4X7gLhDHM7e/DXjF0vaU9PpVFjPlVxBSXyb",
  "PwXPBHF1vLNXQL5rG8IKa/5cgdexy2YWx+y50vU7VtXNhd0scmp0msfYfjaabUsp+oD5DHMqwXqBiQz6k59gMQZYRMAQAIAVMjAF",
  "KjEoFIijqAAAABAAAAAAAdwAAAAAAjfMBgDIAqfIiKRAUJsEQFAAAAAQySRijICZC3BUgIAAHVke7L1I92BIfTybS8FU1HhDSEuW",
  "LKn1/YRqzD6RtXwgscKaUl/8lS/6EB9Bxzvz+KMYx8ufLnG2M8jmeyJj0A+ZqOiaTqdOUL/TLS5T5ZqUk39e6Oo614UcK3mZWkLn",
  "TqrXJ0avmh/wyb+zB6CuRkorG3qB4HrnhLr1mpT0u5t9SpraGfZ1cfB+6/rOj6npupaVX/F9Tsbizq9q1NxT+D2Ztk4J+q9T819p",
  "1lqFvO2vrWldUZcnCrHzL7dviBqauZUe2cS+Emj3TlPRK1TTa7y40pN1KMvrfmj9ePQ8s4m4W1zhuo1qdjONFv3bin71KXwktvgw",
  "PjYRGVNN5zlFAxJgyGAMSGRACRUEEAyVEZUBTOxWb6gnh/zkfvMDlsf6XRa3VSP3oDa+lT9xPHPG5PJnKeWjmoPNGEu8U/sD3YHE",
  "6Saw1lds8j5mo8OaLqcJRv8AS7Stl/SdNKX1rmfZW4afoB5trPhPw5cuc7GV9YVOnln7SH/C8v7Tpes+FHENopT06pQ1Gmlnyxfs",
  "6mPhLlk988vTmTyRxjHLt0A1O1HT9R0yu6Go2Ne0qLpWg45+D2Z+bPPGdjbO906zvqEqF7bUrmjLenVj5o/UzzziTwk0a8c6ui1q",
  "mm13lqEm6lJ/JvzRXqnj0A8P3YPt8T8K67w3Uf5TsnGi3iNxT96lL4Pp8GfFjjfdfECNdSGS9dyP4AQdR0IBQQoFCIh1AoAAAAAA",
  "AAAAAAAAtwsgDF7mRMAXCAAAAAEVJEQyAAAAAACogAdRzyTLyZLYCc2AwAIykYGMfpG1vCP+Kuk/6lR/u4mqUfpG1vCP+Kukf6lR",
  "/u4gfSlshFvOC4ykXCAnl9SgAAABFGK6LuYVbejWpSo1aUKlOacZRmsqS7NPc5AB5bxj4Vadeee40CUbC5bb9hKWaM+b5LrH4Lke",
  "Q61pOpaLfSstVtKlrXXfmprvF7Neptf5VnJ8viDRNN1uwnZanawuKTz5c/Sg+8X0A1X6g7l4hcB3/DNapd2zleaVn88ucqOelTtv",
  "ylt35nTYvPXKAYGAgBCN8zImOYBFROpUAOay/pVN/tr70cXyOSx/pVP+uvvQG2tv+Yp/1V9xnhGNHlRgv2UZAMIAABhAAMchhYAA",
  "4qtvRrU506tOFSE01OMllST6NdTzPjHwp0+8c7nQZKwuX5pewk80pvsv1fu+B6iTyrOccwNT9Y0vUtGvp2ep2dS2rLfzbNd4vZr1",
  "Pxbs2o4g0LTNcsZWWqWkLii8+Xl70H0cWtjwjxD4Ev8AhetUu7dTvNKbz7ZfSpc/oz7dPe2A6d6EaHXnh/AdgA6lfwMQBSADIAL1",
  "AFwQJsC4GCJsoAiL1CAnVlWwAEYLgYAE6lJ1YAAARFRFgyAg6lwhgAQBbgXBCoYAgAAmDJbEKgHUYJnnuVAQjMupGuQGMfpG1nCX",
  "+K2kf6lR/u4mqkeptVwjz4V0hrb8Ro/3cQPqrYLqFsAAAAAAAAABMIoA46tCjVpyp1KcZwnFwlGSynF7prseF+KPh3U0WVXV9Cpu",
  "enc5VbdZcrfnuurh9q+B7wYyhCUXGUVKLTTT5pp7gaiRab646cweh+LfAv5Drz1vSKUnpdSX89Sis/i0m91+w/s+GDzxdAAAALcI",
  "LqMAU59PSd7Sz+uvvRwH6dLWdQt0+tWK/wCZAbZpYSQC6gAAAAAAAAAAAGDjqUKNSE6dSnGcJxcZRkspp7rHZnIAPB/FHw6qaO6u",
  "saDSdTTVmVa3WXK357x6uP3Hm6aazuujNvnTg001lPdZ3PCPF3gP8iXNTW9Hov8AJlR5uKMV/RpN7pfqP7PhgDznn2GOWwXNJ9MZ",
  "XMIB1HUqSyTkARURbhAUBBAVJAAAAgtwAAAAAATqUAQAAEM8yrYnUCrbmOgCAhUiDIAZCAAAuAIi9CFQDAAABgARJ5PWuFvFe0sN",
  "HstPvdKu27ehGm6tKaal5UlnDS7dzyYeVZA9/svFjhW4ko1al5a5/Sq0OX/K2dh0rizh/U35bLWrKrN7RdTyy+p4Zq8uqMWk3lpN",
  "rqwNu41G8c4vPU5U8pPuataBxTxDok09O1S5p01/kpP2lJ/GLyvqPRuGvGSDmqHEVj7Jckrm1Tcf9qD5r4p/ID18Hz9I1Wx1azje",
  "abfUbuhLHv0pJr4Ps/R8z98HmKfddsAUAAAAAAAHDXo0q9KdGtTjUp1IyhOLWU4vk016munibwlU4W1pyt4SemXUnK2nuoPd031y",
  "undeuTZFrJ8niTRrPXtIudMvoJ0a0Ws9YSz7sk900wNWFsgfT4m0W94f1640i9jmpTl5qc8YVSD+jJej2+OUfMWwAuSFAHJa1fY3",
  "FKq05eSaly9Ht9hxoJLmB7ZZeMmjTSjc6de0p/peTyyWevVH1rbxT4UrYVS5ubfP+do4X2ZNfHz3IpPo2BtHpXFOgamsWWsWdaXb",
  "2nll9TwfXU21FprD5pp7movPOcc+/U+5oHFnEOi1I/iGqXEKaa/mpvzwfphgbQxba5lPJOGvGGlOf4vr9gqC5JV7ZZivjB818U/k",
  "el6RqtnqtpG60+8o3VF/p05ZX8U/RoD6AC5pAAAAAAAHFcUKNelUo1qcalOpFwnBrKcXyaa7M5RgDW/xQ4PqcK6tKvawctIuaj9g",
  "+b9jLd05dfh3Xrk6ilh81zRtVxDpFnrmlXOmX9Lz0q8fLnHOL6SXqu5rLxNol3w9r1zpN570qUv5ueOVSm/oyXx+/IHz88+wZI81",
  "zLgCBFAERSIqAqHUBbgAAAAAAAIAEEAIC4AEKiIqAmeY6jqUCAAAgAAGQXkAQIXqwACfIAAAAAADAaYCeQJgiWHyMgB+rRdU1DRr",
  "38c0u9q2db9KVJ4UvSS2a+J7N4f+KNtqjp6bryp2N68Qp11+ZrPt+zL02fpseH4InjKksxe6xlAbdwk3FNv4/wDnUzW3M8K8NfEa",
  "vpdalpeu1519PyoUriXvTt3ss9XDHzR7hRrRq0oVKU4zhOPmhKLzGS6NPqBygLYAAAAJ5VnOCgDz/wAYeFvy5oUr2zpSnqNinOnG",
  "K51afNyh6vdr1XqeBKSksp8jbtwi3lp5+Jrt4ucOS0DiupXt6Sjp9+5VaOFhRnn34LthtY9GB07G4RF2MlgARhsACcy5IARMcyoA",
  "RLnyWx9DQdZ1HRL1XWm3lS1qvfyvlL0ktmj8ASYHu/h/4mWWsSp6dq6p2N9jEJrlSq/B9H6Hoil9fr1NRYyw+aT5npnhv4kVNOnS",
  "0nXq06tm2o0rl5cqL2Sl3j67ge4LYHFQqwq04VKc4zhOKlCUXlSTWU0+pyrmgAAAAABhHnnjNwvHW9Clf2tGTv8AT4upDy71KS5z",
  "j6tLLj6p9z0MwlHnnAGoSn5ve5c+xl952jxV4dfDvF1enQp+Sxu07i2eOSy/egv6svscTqqYGREXHIIAAAKgRFAIBbgAFuAAAAAE",
  "yMsBkFwAIAAKRNhdh1YAAAABgAAABSDIAAAUBAAAAHMPYAAggAAAARynyPRvCPjmek3VLQtVrt6fWko29ST/AKPPon+w/s6YPOQu",
  "WezA27i+S57oyPMvBbjCWqWf8n9Qqp3trDNCbfOrTXLD/aj9qw3zTb9NWyAAAAAAB1XxL0CHEPCl5aRgpXVKLrWz6+0ispL480dq",
  "I4p89mBqHjy8nyaeGn3L1OyeJ+k/kbjbULaEfLSqydxSwuSjLnj5NnWlyAuAUjAgAAFIABkjEqAdSLKe5kkske4Ho3hHxzPSbuno",
  "WqV3KxqvFvVl/kJvkov9hr6j3SD91Y2xy+BqKnh5Pb/Bfi+Wp2D0O+q5vLWCdCT3q00sYfrH7ue4Hpq2BI/RXwKAAAAAAdE8Z9A/",
  "LPB1evTh5rrT27ily5uKXvx/4ef+yjXmDys9+Zt5UpxmpRa5OLTWMrn6GrnHOjvQeMNR0xJRpQqudFd6cvej9SeAPkoEjzwyvmwI",
  "i9QAKtgFsEBOozzLgYAibKQJsC9QgQAxuAgGQMAAVD5DYCdSgmQAAABAAOo6hdR1AAMIAVE6jqBUAgAKQAUgAFQIABSFQAjKRgfp",
  "0i+udM1Ohf2lV069CSnCS7/c+XLn0NnOFdbpa/oNrqdB4VaHvxX6E9pR+TNWc4PT/ATXZW+rXGh1pe5dQ89BN8vaRXNfNZ+oD29P",
  "KTBI4UUltgoAAAAAB5H+ENpq/FdO1qEOdOpKhUfo+cftz9Z48bL+JOlx1XgrVLVrM40nVh6Sh7y+xNfM1oT5IDJEYRAAAAAFwBUg",
  "EGAQBOoEZ+zQtRudJ1a21C1nKFWjNSWOq6pn5GY9fkBtboOqUdX0i21G2eadekppZ2eOcX8D6K2R5D4B683C60OvPmv563//AGS+",
  "89eQAAAAAAPF/wAIrSVGvpuuQjv5rWq/rlBv7Ue0HVfFTSY6vwJqluo5qwp+3p89pU35uXyTXzA1ojnBmjCL5ZMk+YFC9QwAzzL1",
  "GAAAABdSFXUYAmR0KFsBEUBAAAA6BbBBACFGAIUACLIAAAAAAXAEKl1AAAAAAAAAQAAACggFIAAxufr0S+q6dqttfW83GpQqRmmv",
  "Rpn5TFNxnyfUDbm1rQuLalcUnmFWCnD1TWUcp1Dwkv5X/A1hKcm50M0Jf7PJfZg7etgAAAAADiqwVSE6dTnGaax3T5GqWtWzs9Zv",
  "bRrHsq04Y+DeDbFrK9TWjxOtvxXxA1imljzVPaL/AGln94HW9mQq9ByAgAQAuSADJAIACdShoB0MHuZEA+twZqk9H4isr+DaVKpF",
  "yS6xzzRtJSlGVKE4yUoyScWuq6M1Fg3GeVvk2U8MNSep8E2Facm50oexm33hy+7AHaQFsAAAAHDWoxqRnTmsxmmnn1WDmI0m/VAa",
  "katbOz1a8tGudGvOH1Sf7jhS5nY/FC2Vrx/q9NLHmquovhJHW1uBX8QUnVgMspFzKgACCABAYAIhRgAAEBMguAAwNiZAFBMlQAhS",
  "dAAAADqB1AFRGVAEAAACCAFIgAAAAAAAAAKQqAGMsZzuZEaQHtv4PtzKroOoWvmx7KtGaXbzRf8A/J6gtjxn8Has1fatbqXJ0qc8",
  "fBtfvPZY8opegFAAAAADX3xvo+x8Qa1TGPbUKcs98LBsEeIfhBUVHiOxr4+nbuP1NgeZIMq6kAgAAAAC5GSADJAmSgMEC3HcCJe8",
  "e1/g+3TqaNqNo5vFGtGcY9vNFp/ceKdT1X8Heo/yjq1HPJ0YS+qT/iB7QAtkAAAAExzzkoA188dKHsuP6lRrCq21OWe+OX7jokd2",
  "enfhCU0uJLCaXOVq8/8AEzzGO7ApFuXuTqBUkEAgAAAPcALqAQAXUAAAAAAnVhDuTqBSohUA7kKEgIB1AAILqRbgZYBMjIFBMlAI",
  "DmAAAAAAAFuCbMCgAAAVAERmUTF7gep/g7U3+VNWqY2oQjn4yf8AA9qWx5T+Dza40vVLtr85WhBP+qm2vtR6stgAAAAAAeLfhCP/",
  "ANW05Z/yMvvPaTxD8ICpniSzp7+W3b+0DzMj3LsiAQAAAAwAAQAuSACrcMIdQIerfg7U29R1arjkqNOL+Lk/4HlXXsez/g82vl0z",
  "VbtrlUrU4J/1U2/vA9Uj9FfAoWwAAAAYtvJkYvZv1A8R/CDnniKwh+rbPPzkzzGPXud98dKzqcdTp5yqVtBfDKz+86FHrgCkKRgV",
  "AIAAgAAAQAAAAgF1AmQXAAxz6guAA6BAAVbkYW4ABgAAAALghVsA6gAAOYAAAACZGSgTIAQAqGB1AFW5CoCr0MXu8mUdzktLWrd3",
  "VK1op+1rVIwj8W8ID3/wWsZWPAtrOUHGV1OVw0+zeF9iTO8LDSa2PyaRZU9P0q0sYZ8tvQhSXPpGKX7j9YAAAAABNtzwPxzrKrxz",
  "Kmn+at4R+tZPeakmvNl4SWTWbj6+eocY6pdKSlF13GPwSwvuA+CtiMpOoEHUB4AZIO4AqAWwQBAACoPfARccwJ1fNcsmxPg9p0tO",
  "4Gs/PBxqXTlcSz+1jH2YPA9G0+pqep29hS+ncVY016ZaWTafT7WnZ2FvaQ+hQpQpx59IpJfcB+hc1kBclhAAAABi3iL68zI/PdVI",
  "0qFWrN+5CMpS+CWWBrp4r3H4zx/qkukJqml/VikdVP263dSvdWu7ybblWrSm38X/AAPxACdeZRgAgAAQAAAIAAgtwuoDqEAAAAEB",
  "M8zICFwMAB3IvgVEAAIMAOoKgIVDAQAAAAAAe4I9ygCFROoFIXqOQAEW5fgBUVbkRUvkBUsZO++CeiLUeLPyjVpuVvp8PPty9q+U",
  "V8d38jo1GEqk1CMXKcn5YxS3eeRsb4acPrh7heha1I4ua38/cPqpyS935Ll8gO0rZAIAAAAMW3kyMHuB8zim9jp+g395J49nRbi/",
  "XGEavV5udWVSX0pPL+J7h45aqrXhynp0W/PdVMSX7K5nh03ltgYZIQACFfJEAFwReoyBSFQwBMlQwVAEuxko9BHmc9rQq3FeFCjF",
  "zq1JKEI4+k28ID0PwK0P8Z1qvrVaHmo2cHCl2dRr90fvPcFsj4PBOhU9A4atNMjj2kIZryX6VR4bf18vkfeWyAAAAAAB13xDvlp3",
  "B2qXOcN0XCPxlyOxHl3j5qcaWk2mlRk/NWqurJLtHb7wPF6jw9+fU4zJvuYgAAAQCADqEB1AAAAAAAAQAAAYGSbMTJAULcInUC9W",
  "QAAAABUQqAABAAAgAJkAOgQAFIMgAQoAi3M1yIl6GSXdAEuZkkIrmdj4E4ZuuJdap2sFKNrD3rmslyhHsu8mB2bwV4XlqF+9eu6f",
  "+DWrxQT2qVO/wX3nt0Iryp89urPzaVp9ppun0bG0owpUKUFCEF2S+31P1gAAAAAA45PGc79DkPg8bavDROHbzUJP34wcaS7zfJAe",
  "MeMWr/lPjCrRhL+atI+xWNs9ftydJzyz3OS6qzrVp1ajzObbk+7ZxZAEKQBghSMAMomSoCZKs5LgYwBUipZKtixXPCAyhHPP7D03",
  "wQ4ad3f/AMoruH+D28nG2T/SqdZfI6vwBwxc8R6zCioyVrTfmuKvSMey/afY2J0yxtdPsKNlZ0VRoUoKEIx5YWPv9QOeCSisZ27m",
  "QAAAAAAgMJSw3l4WDXLxU1lazxjdzjPNCg/Y0+2I8n9byz2fxJ1taFwrd3MXm4rYo0V+3Ll9iy/ka2VPek25ebO77gRcgAAAAAAA",
  "AEEAAQAAAAAAAAAxMkjFbGSAEe4yAC+YC2HUAOoQAdSgIAEAAAHUBghSMAYsyGMgTIwFjPNFSAY9BgqyZJJgRbmaz+jzQjB+ZRXv",
  "N8klu/kd54K8OdX1mpSub+E9P094l5pxxUqr9mL2XqwPhcIcN6lxJqKtbGnilHnWry5Qpr1fV+iNhuF9BsOHtKpafZU/djznUe9S",
  "WOcn/wCcuhz6BpVho+mUrHT6MaVCCyknnzPu31b7n0EgIlyWehQAAAAAB7AYSl5U2/8AueI+NnEDu9Zjo9CblQtfeqdpVP8Atsek",
  "+IevQ0Hh+vcqSdzUj7KhHq5P+CNcruvUr3dSvUm51JycpSfV9wOJtGJWQAQAAiFHICYyXGAipZAFS9CxXMyhTnVqxpU4ynOT8sYx",
  "WcvsBIrniPPvk7BwbwxqXEeoews4KNCPOrcTXuU16938Ds3Bfhfqd9OF3rObG1fvezf5yS+HQ9l0XS7HSrClZ2FvGhQguUVu/Vvq",
  "wPz8NaHY6FpdOwsafljDDlN/SnLHOTff/wAR9ZYwsbBJIAAAAAAAwlLHX0MzqXiXxFHh7QKk6U1+NV24Uo8sptc5fJAeXeNOvy1T",
  "iSWnUpt21l7iSfJ1H9J/LGDoOc5ZnXnOrWlOcnKcnmTfVmCAgRSAAgO4BAIAAAAAAAAAAAAAABJEGQACAQAIAAAAKh8iACoIInUC",
  "gImQKRbso6gME2ZfNh+iO26L4d8U6la0rqnZ29OhWipwnUrxWYtZTwm3s+wHUsZ5lw+r+w9P07wf1GbTv9Vt6S7UYOb+07TovhXw",
  "3ZzU7qNe/mv87Pyxz8EB4bZ21zd11RtqNSvVbwowi3k7zw34Xa/qMo1dR8ul0HzfnXmqNf1enzPb9K0rT9NoqnYWVC1jhZVKCTfx",
  "fU/YoRWywB1bhjgfh/Q4Qnb2ft6+7uK780vknyXyR2mMUl1LhZzhFAAAAAAAAAH57y6pWtGrWr1I06VKDlOUnyil3OaUsfaeNeMv",
  "Fv4zVqcP2Ul7KD/wmpF85ST+ivRbAdT8QuJp8R69UrQlL8Totwt4vlmOfpfF7+myOr783uR8pfDkGwDIAAKEshb43eegE55GOeTv",
  "Nh4YcU3FOFWVG2oQmk17SsspPulsfbsfB+9qSze6rSpx7Uqbl94HlqyumD9Gn2N9qFyrawtatzWk8KNOLl92x7jonhVwzZSVS6jW",
  "v6sf87Pyxz8Ed10zTLLTqKp2NpRto4WVTjjPxfUDxXhvwq1q8lCrq1WGn0uTdP6VRr5ckeq8LcI6JoFJfiVmvbeVeavU96b+fT5H",
  "YVGK2QwuwEjBL4458zIAAAAAAAAHFUqeTzOUsJJtt7Jb5foB+fVb+jp1lWvbmrGlQoxcpzk+WP455GuHG3ElzxHrNS9qJwp840Kb",
  "/Rjnr6nYPFfjGes309Lsqqen0J82v8tPv8Ox5+22+b+YABPkRAAAwJnmOpcEAoCyEAQQQQAAIAAAAAAAACLPYAAEAAAA6/IAti4C",
  "2AGPUZL1JgBllJgoFQIEBRkIjAyist77P9xtVwzBLh7TVhJK0pf9CNVae+Tavhl+bhzTX3tKT/5EB9BRjukXCAAAAAAAAAAAAAYO",
  "TWfQrk0ec+JvH9LSqdXStJqQqXsouNSsnmNFdV6y+4Dj8V+OYabSqaLpdRSu5xar1VzVFPp6t/YeI1akqk3KbbbfNt5ZlWrVK1SV",
  "SrOUpSbblJ5bb7nEBfmQAAAAKjktUvbRz37fA4zltOdaPxA2ytoxdvTeN4L7jlSSOGwebG3b3dKL+w5gGEAAAAAAAAAAABxynGKk",
  "5T8qWW3LZL4gWUvLnL257nkXi3x1lVdA0qrFr6N1cQf1wj89x4peIUZQraLolVNPMa90v+mP8TyScpSz5m315sDHLaw8jfqEEAIV",
  "ZJ3ApOoQ7gXqMEKgHoAAAAAAAAAAAAAAACAAAAgtwAAADIAAuCIZALqAh1AAAAh+kEHvsBYfSybV8KvPDGlPvZUf+iJqpHc2q4T5",
  "8LaS/wD8Kj/dxA+mAAAAAAAAAY5fP07IDI4K9xTt6VStXqQp0qacpTk8KKXfsfE4t4v0nhq3cr+4jK4abp29P85Pty/RXqzw7jfj",
  "bVOKKzhUfsLFSzTtqcsxXrJ/pP4/LAHcPEHxNdxGpp3D9RKhJONS7xzn3UE9l6s8prVJVJOU5Sk285bzn1MM+r5kYAAAACJsCj4A",
  "ICo5bT89H4nEjms/z0fiBthYf0G3/wBFH7kcxw2P9Cof6OP3HMAAAAAAAAABi20/+2TrnGHGWk8M0Grysqt203Ttqf05dm/1V6sD",
  "7d/e29ja1Lq7uKdvQppuVSbxFfxZ4l4ieItfWHU03SZyo6flqc8YnX/gv/Gdc404w1Pii7893PyW0W/ZW8H7kPj3fqzrmc9X9YFl",
  "JyfMiyRABgpEUATqABcEKTqACHUuEAQQAAAAAAAAAAAAAABAABCgAAEABcEGQAA6gVEAAApFuBURc2VE6gWO5tVwny4V0n/UaP8A",
  "dxNVFnnjPJG1vC6S4Z0tLZWdH/oQH0QAAAAAAADx/wAS/EfVrHWr7QNJt3Zyoe7O5qxzUeVnME9l6vPdYPYDpniRwVacUWcq9DyW",
  "+qUov2Vd/Rkl+jP09egGvd1Vq3NWVe4qTq1ZvMpzk22/Vs4sd8/Wfq1GzutPva1lfUZ29zRl5alOfNp9/VevU/Pz6rn1QGJCvfYg",
  "BDqAAREtygAAOgBHNa/nonCjms/zyA2ztFi1pLtCP3HIYUOVGCxj3V9xmAAAAAAAAB4/4m+Iur2es3fD+lW9SxlRfkncVIpymn1i",
  "scl2Z5RcValzOVWvOVSpJ5lKUvM2/V9TYbxI4MtuKbD2lNxoanQT9hWf0X+zL09ehr7qNndWF9Vsr6jO3uKMvLUhLm0/3r1A/K+e",
  "ebIZ45Yaw+pjjsgItiLOS9SJ8wKMgnXAFJkdR1AvMdQmwvpMAUiKAHMLcAAAAAAAAAAAA+QLj1AGKAAAAAEAEAJkpEAyUmCgVIIi",
  "fMqADACAdRgADHOG/Xl6Gx3hNxBR1zhK1gqsXdWUI29zBYymliMsdpJJ/HPY1yaPrcHcRX/C2tx1OxSqcvJWot4jVg3s/Vbr/wBw",
  "NqFsD5XDutWWt6Rb6lp1x7a3rRypOPOLW8ZJbSXVfVyPqx2Wc/MAAAAAAEcItvluUAdO8ROCbPiaylVpKNvqdKL9jX2T/Zn3j9xr",
  "7qNld6bqFawv6M7e5ovyzhNc16/D1NsvJHny3On+IfBdlxPYuUMW+pUk3RuG/wDln3i/s+wDXXH19skwfr1Owu9Lv61hqFCVvc0X",
  "icH967p9Gflxzx1AxBljqYgAgAAIigMGdKfkmnnBjkjWQNpuFNYt9a0G11C1qxqwnSXncWvcmkvNF+qZ9dbGsvh/xXecK6m6tL+e",
  "tavKvQbwpLuuzX2mxOg6tZazptG+0+v7ahUXJ45xePoyXRgfRAWwAAAAAAMXCLecHS/Engm34mtHcWsY0dVo/maryo1F+pLuvXoz",
  "uxPKs5xzA1LvbW4sruraXVGdCvSk4zpzXOLTwcOO25sJ4k8D2/EtpK7tcUdVpJ+zq9KiX6El19GeB39nc2F9Wsr2hO3uKMvLOEt4",
  "v969QPytcyYOTD2aw+xjgCYIUYAiSGEUAEiLcq3AAAAEAAAAAAAAAAAAAmQXAAgAAIAACIdR1ApNijCAvInUAB1KgAAAAAAC9DBp",
  "czMxaA+7wHxbfcIatK6oqdeyrYV1ap4U1+vHtNfabH6Dq1jrOl0NQ024jXtq0cwlHHLl9F9n3Rqk0879D73AfFeocI6pK5tVKvZV",
  "2ldWaeFL9qHafXOz6gbQx2WQfL4d1qx13TKGpabcKvbVk/LJLmn2kujXVM+nH6KznbqBQAAAAAjjF7ooA6l4g8GWHFFg24q31Ckm",
  "6FzhvH7Mv1o/d0NfdX0+90fUqunajbyoXdLk4PmmujT6p9MG1zjFvLR1Xj3g+x4n050pL2F7RTdtcJc4/sv9n0+oDW9rnjGGt0Rn",
  "7dX02+0fUa2najbuhdUeUovZro13T6YPxtdAMQXHoQAVbkKgC3HMLqVbgYtdjsfAnFl9wvqft6Wa9tUwq9BvlJd12a79TrzRjs3s",
  "BtXw/rFlremUtQ0+49tQqrsk4vrGS6NdT6MXmKfdGsnA3FV7wvqf4xQftreriNxby2qLuuzRsPw5rVlrel0b7T63taU1jHWDxzjL",
  "s0B9UBPKT7+gAAAAAAI4pnTPEfgm04ns5VqHlttUpRapV9ozX6s+69eh3QnkjnOOYGp2o2V3pt/WsL6hO3uaL8s4T3Xr6rsz82Pk",
  "zYrxD4LsuKLGUoqNvqVJN0Lj6/dn3i/s6Gvup2N5peoVrDULedC5ovE6bXP4ro16gfme5GX0xzIAAAAAAAAAAAAAAAgAAAAAACZA",
  "AE6lIEBUMeoADAAADIAALYdSx2AAIfMAgggAAAAAATBi1l/YZk+QH3eB+KtQ4U1Z3donXtq2FdWjlhVUv0o9FNdGbGcOa7Ya9pdL",
  "UdNuFXoVIt8liUH+rJdJLt13Rqtjkz7XB3E2o8L6q76yaqU6mFc202/LVS68tpLo9/lyA2kWwPi8K8QWPEWkU9R064dSDWKkGl56",
  "cusZLpLPyZ9pbcwAAAAAATyRy3jmygDq3HvCFhxPp3sakVRvKSbtrhLnB/qv0Zr1rOl3ui6nW07UaDo3NLl5d1JdJLunusG12EdW",
  "4+4SseKNP9jUiqV7TTdtcLeD/VfowNbsc8NYx0yYtdkfv1zS73RdSq6dqdF0Lmm8eVc1JdJR7pn4sPPNY7pMCYJjmUACdSke4GUe",
  "pi1zKgBE2tng+5wZxPfcM6p+NWr9pSlj29vJ+7Vj/FHw8Bb5XJgbS8M67Y67pdO+sK6q05R95P6VOXaXZr7T662Rq9wfxJf8N6p+",
  "OWcoyhL3a1Cf0KsfVd+zNhuEuIrDiLSqd7Y1njGKtKTzOlLqn/HqB9sBPKAAAAAABPLHsdQ8RODLLimwcli31Gim7e49efuz7xf2",
  "fYdwJ5Y9gNTNSsbzTNQr6ff287e6oPyzhLdeq6NdmfmxlmxXiPwVZ8UWTqU/Lb6nRT9hXez/AGZ94/ca+6nY3ml6jW0/ULepb3VJ",
  "4nCW/o13QH5wWPNbLYgDHqAAAKAIAAAAAFIAAAAAACYYKAIEAACAAbshQAHUAAVbEXUqAIAAAAAAAAAAEAUCEfLmtzIgH1OE+INR",
  "4a1ZahptVKbSVSjPPkrR/Va79nujYzhDifTuJdJjfWE8NJKtSm/fpSxs+/Pr1NX1y2yft0fVtR0itKtp93WtaklhypS8ra7AbXpv",
  "HNcxn0NaKPHnFlFNQ1u6af6zT+9CfH/FsuT1m4+WP4AbL+Zdc/UPMvX6maxT424nl9LWrv8A4zD+WHEb31i8/tWBs+5Nf+zJ5n3R",
  "rB/KziBvnq97/bMwfFGvPk9WvX/vmBtF5n3Rg5Ln29GavriXXctfla8x/pmR8Ra43n8q3qx/96QHv3GPDWm8S6e6F3TlGtTTdGvD",
  "6dJ9s45rujX7iHSLnQ9Vraddc5037sksKcejXo9zlocWcTUpYp63fJdM1W8fXsfi1LUr7Url3F/czuK2MeebywPzLt2BFsMgGyAo",
  "FQAAAIrwBjvtyPqcMa9qPD+pxvtPr+Sa92cZfQqx6xkvuPmMgGzPBPFVhxNpsbi1k4V44VahJ+9B4+1Z6nYcvGX9xqdY31zaZdtX",
  "nSl3jLD+s+lR4r1+k8R1e9X++kBs/wCdd39RPP6Gsb4w4i6avef2rMXxbxC851e8/tWBs/5/h9pPM+6NX/5WcQf/AFa9f+9ZHxRr",
  "z31a9/tmBtD5n3Q83qjVyXE2vPl+Vb3+2Zj/ACk1vrqt7/bSA2gm48+WcvozqfH3COn8U2WKkfYahRi3QuUm2v2Zvqn9h4VLiLW3",
  "/wDFL3+3l/EUuKOJKT/m9a1CHwrsD8up2Nxpmo17C8g6dejUcKkVzXJ4yn1Xqfl59dzlvLu5vbidzdVpVq0/pTk8tnEtkBSAAUhS",
  "ACkAAAAAAAAADqAAJkAAAskQQFW4QAEKiYKgDA68wACAAMvQAAAAAAAAACjqABVuydSoi3APcdyk+oCDBkRbgY4LjuioLcCYGEVb",
  "hARIYMiPcCJcwUgFAAEMkRDIFIikQFCQADcNAnMBgmDIAYjBeoAmBgq5sMDHBUvQFyBMcyJc+ZQACBeoAAgFIAAAKBAAAAJkCghU",
  "ACC2CAnyBQBihzAQFW46hEb5gUAAAAAAADoMgAMlJ1KAAAAdQUAgAgBSdSgCB7lYACPMnMCgmWUCLcdQAC3LghUBO5CkAAACkAAy",
  "QJkZAoAALqCACkW4yFuAW47lIBUMBEyAIAAAKtwIUEAAAAAUCFBAAAAEZUMAPkAABNmXqyboBkDn2AGIAAyQJ1KgAQAAIdQgAAAA",
  "AB1CYKkBOeSke5QAAAAACgEAyIh1KBMtAdQA+sAAAQAC5IUCAAAAUCAAAUhQGRkEAAAAUEAuSAvxALYLcLsNmBAUgAoQAgBQICkA",
  "AAAAAAyAAAQwAAMc89wL1C5AIAAAJ2A7BbgFuOo6sPcB6lJ3KgHUE6lAdAAA3ZUiP9xVsgAAAEK9yMCrn3BHsVbABzBVv8gBOpYk",
  "/SYAcwVAQFe5ABSAAAAAAAAAAAAAAAAAAAAA6gdQAAAAACkAAAACkAAAACkQAABbBAAAtgHoTqFsVAQpCoCZ9QUgAAdAAAA//9k="
].join("");
...
function Login({onLogin}){
  ...
  return <div className="login-screen"><div className="login-card">
    <div className="login-logo">
      <div style={{width:80,height:80,margin:"0 auto 14px"}}><img src={LOGO_B64} style={{width:"100%",height:"100%",objectFit:"contain"}} alt="RR"/></div>

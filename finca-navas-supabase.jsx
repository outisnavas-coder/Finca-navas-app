...
function Login({onLogin}){
  ...
  return <div className="login-screen"><div className="login-card">
    <div className="login-logo">
      <div className="login-emb"><img src="/src/Logo.png" style={{width:72,height:72,objectFit:"contain"}}/></div>
  ...
  return<>
    ...
    <div className="app">
      ...
      <nav className={`sidebar ${!sideOpen?"closed":""}`}>
        <div className="slogo"><div style={{display:"flex",alignItems:"center",gap:10,marginBottom:6}}><img src="/src/Logo.png" style={{width:28,height:28,objectFit:"contain"}}/><span style={{fontFamily:"'Playfair Display',serif",color:"#fff",fontSize:17,fontWeight:700}}>Gosh Investment</span></div><span style={{color:"#C9A84C",fontSize:11,letterSpacing:"1.5px",textTransform:"uppercase"}}>Sistema GOSH · Panamá</span></div>
